...
{ 
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539462,486539462)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539463,486539463)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539464,486539464)
				}
			}
			Component.onCompleted:
			{
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539465,486539465)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539466,486539466)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539467,486539467)
				}
			}
			Component.onCompleted:
			{
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539468,486539468)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539469,486539469)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539470,486539470)
				}
			}
			Component.onCompleted:
			{
